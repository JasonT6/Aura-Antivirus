...
def game_start_screen():
    ...
    arcade.draw_texture_rectangle(800, 400, 0.8 * button_1.width + expansion_button_1,
                                  0.8 * button_1.height + expansion_button_1,
                                  button_1, alpha=transparency_button_1)

    #   BUTTONS
    arcade.draw_texture_rectangle(750, 300, easy_button.width + expansion_easy_button,
                                  easy_button.height + expansion_easy_button, easy_button,
                                  alpha=transparency_easy_button)
    arcade.draw_texture_rectangle(750, 200, medium_button.width + expansion_medium_button,
                                  medium_button.height + expansion_medium_button, medium_button,
                                  alpha=transparency_medium_button)
    arcade.draw_texture_rectangle(750, 100, hard_button.width + expansion_hard_button,
                                  hard_button.height + expansion_hard_button, hard_button,
...
def player():
    ...
    arcade.draw_texture_rectangle(person.x, person.y, 0.25 * player_image.width, 0.25 * player_image.height,
                                  player_image)
